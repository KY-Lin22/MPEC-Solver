...
FunObj.L = Function('L',...
    ...
    {'x', 'p', 'w'}, {'L'});
FunObj.G = Function('G',...
    {MPEC.x, MPEC.p, MPEC.w}, {MPEC.G},...
    {'x', 'p', 'w'}, {'G'});
FunObj.C = Function('C',...
    {MPEC.x, MPEC.p, MPEC.w}, {MPEC.C},...
    {'x', 'p', 'w'}, {'C'});
FunObj.PHI = Function('PHI',...
    {MPEC.x, MPEC.p, MPEC.w, MPEC.s}, {MPEC.PHI},...
    {'x', 'p', 'w', 's'}, {'PHI'});
...
Gw_formula = jacobian(MPEC.G, MPEC.w);
FunObj.G_grad = Function('G_grad',...
    {MPEC.x, MPEC.p, MPEC.w},{Gx_formula, Gp_formula, Gw_formula},...
    {'x', 'p', 'w'},{'Gx', 'Gp', 'Gw'});
