...
Fun_Init = struct('L', 0,...% no deviation for the VarInit
    ...
    'PSIg', Fun_Ref.PSIg, 'PSIgSigma', Fun_Ref.PSIgSigma, 'PSIgG', Fun_Ref.PSIgG,...
    'PSIphi', Fun_Ref.PSIphi, 'PSIphiGamma', Fun_Ref.PSIphiGamma, 'PSIphiPHI', Fun_Ref.PSIphiPHI);
    ...
    if exitFlag
        ...
        if ~FRP_FailureFlag
            ...
            Fun_FRP = struct('L', full(L),...
                ...
                'PSIg', Fun.PSIg, 'PSIgSigma', Fun.PSIgSigma, 'PSIgG', Fun.PSIgG,...
                'PSIphi', Fun.PSIphi, 'PSIphiGamma', Fun.PSIphiGamma, 'PSIphiPHI', Fun.PSIphiPHI);
            % termination message
